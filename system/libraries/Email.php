...
class CI_Email {
	...
	var	$protocol		= "tls";	// mail/sendmail/smtp
	var	$smtp_host		= "smtp.office365.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "crm@atctp.com";		// SMTP Username
	var	$smtp_pass		= "Krp$1599!";		// SMTP Password
