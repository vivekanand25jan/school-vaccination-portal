  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Vaccine List</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header" style="float: rights;">
                <button type="button" class="btn btn-primary btn-sm btnStudents">Add Vaccine</button>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $val['totalCount'];?></td>
                  <td><?php echo $stTitle;?></td>
                  <td><a href="<?php echo BASE_URL;?>vaccine/editVaccine/<?php echo $val['vaccineId'];?>" title="Edit Details"><i class="glyphicon glyphicon-pencil"></i></a> | <a href="<?php echo BASE_URL;?>vaccine/changeVaccineStatus/<?php echo $val['vaccineId'];?>/<?php echo $val['status'];?>" title="<?php echo $stTitle;?>"><i class="<?php echo $stClass;?>" id="changeVaccineStatus"></i></a> | <a href="<?php echo BASE_URL;?>vaccine/deleteVaccine/<?php echo $val['vaccineId'];?>" title="Delete Record" id="deleteExclusive"><i class="glyphicon glyphicon-trash"></i></a></td>
                </tr>
                <?php $k++;} }else{?>
                <tr>
  ...
  $(document).ready(function () {
    $('.sidebar-menu').tree();
      ...
      $(".btnStudents").click(function(){
        window.location.assign("<?php echo BASE_URL;?>vaccine/addVaccineRecord");
      })
  });
</script>
</body>
