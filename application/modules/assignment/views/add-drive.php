    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"> Add Drive</h3>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Drive</h3>
              <h4><?php echo isset($errror_msg) ? $errror_msg : '';?></h4>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" name="addAgency" enctype="multipart/form-data" method="post" id="addStudent" action="<?php echo BASE_URL;?>drive/addDriveAction">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Drive Name</label>
                  <?php echo form_error('drive_name'); ?>
                  <input type="text"  name="drive_name" class="form-control is_required" id="drive_name" value="<?php echo set_value('drive_name'); ?>">
                </div>
                <div class="form-group">
                  ...
                  <select name="vaccine_name" id="vaccine_name" class="form-control">
                    ...
                    <?php foreach($vacc as $k=>$v){ ?>
                    <option value="<?php echo $v['vaccineId'];?>"><?php echo $v['vaccine_name'];?></option>
                    <?php } ?>
                  </select>
                </div>
                <div class="form-group">
                  ...
                  <input type="date" id="txtDate" name="drive_start_date" class="form-control is_required" id="drive_start_date" value="<?php echo set_value('drive_start_date'); ?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Drive Class</label>
